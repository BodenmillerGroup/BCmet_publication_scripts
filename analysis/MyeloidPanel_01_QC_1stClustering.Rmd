---
title: "MyeloidPanel_QC_1stClustering"
...
In this script, we work on the inital myeloid cell-panel SCE object to
...
sce <- readRDS("output/SCEs/myeloid/myeloidSCE_initial.rds")
```
...
sce <- sce[, which(!(sce$Tissue.Type %in% c("ROI_yy", "ROI_xx", "ROI_zz") | is.na(sce$Tissue.Type)))]
```
...
markers_UMAP <- c("MPO", "SMA", "panCK", "CD38", "HLA-DR", "CD303", "CD68", "CD163", "CD20", "CD3", "LAMP3", "CD11c", "CD16", "CD8a", "CD4", "CD31_vWF", "CD14", "E/P-Cadherin")
```
...
labels <- read.csv("data/cluster_annotations/myeloid_full_cluster_annotation.csv")
...
```{r save-sce}
saveRDS(sce, "output/SCEs/myeloid/myeloidSCE_clustered.rds")
```
